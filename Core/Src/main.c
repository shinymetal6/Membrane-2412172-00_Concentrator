...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, ISM_SS_Pin|ISM_CE_Pin|ETH_NRST_Pin|PW_N_Pin
                          |WIFI_RESET_N_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LED_GPIO_Port, LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ISM_SS_Pin ISM_CE_Pin ETH_NRST_Pin PW_N_Pin */
  GPIO_InitStruct.Pin = ISM_SS_Pin|ISM_CE_Pin|ETH_NRST_Pin|PW_N_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : ISM_IRQ_Pin */
  GPIO_InitStruct.Pin = ISM_IRQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(ISM_IRQ_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : I2C1_IRQ_Pin */
  GPIO_InitStruct.Pin = I2C1_IRQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(I2C1_IRQ_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : WIFI_RESET_N_Pin */
